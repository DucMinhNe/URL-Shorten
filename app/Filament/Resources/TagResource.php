...
class TagResource extends Resource
{
    ...
    {
        return $form->schema([
            Forms\Components\TextInput::make('name')->label('Tên')->required()->maxLength(48)
                ->live(onBlur: true)
            ...
            Forms\Components\TextInput::make('icon')->label('Icon')->helperText('heroicon-o-* (ví dụ: heroicon-o-fire)'),
